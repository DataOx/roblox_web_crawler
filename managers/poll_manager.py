...
class PoolModuleManager:
    ...
    def __init__(self, spreadsheet_id: str = None, saving_db: bool = True, spreadsheet_saving_delay: float = 0.01):
        self.spreadsheet_id = spreadsheet_id
        self._sheet_name: str = ''
        self.logger = Logger(self.__class__.__name__)
        self.saving_db = saving_db
        self.spreadsheet_saving_delay = abs(spreadsheet_saving_delay)
