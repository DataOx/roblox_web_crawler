...
class TestScrapyRoblox(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.universe_id_for_check_badges = '2906645204'
    ...
    def test_badges_search_won_ever(self):
        self.scraper.badges_search_won_ever(self.universe_id_for_check_badges)
